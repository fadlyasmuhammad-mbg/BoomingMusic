...
import com.fadly.fadence.coil.CoilBitmapLoader
import com.fadly.fadence.core.appwidgets.BoomingGlanceWidget
import com.fadly.fadence.core.appwidgets.CardWidget
import com.fadly.fadence.core.appwidgets.FullWidget
import com.fadly.fadence.core.appwidgets.WidgetTheme
import com.fadly.fadence.core.appwidgets.state.PlaybackState
import com.fadly.fadence.core.appwidgets.state.PlaybackStateDefinition
import com.fadly.fadence.core.audio.AudioOutputObserver
import com.fadly.fadence.core.model.player.MetadataField
import com.fadly.fadence.core.palette.PaletteProcessor
import com.fadly.fadence.data.local.MediaStoreObserver
...
import com.fadly.fadence.extensions.isBluetoothA2dpConnected
import com.fadly.fadence.extensions.isBluetoothA2dpDisconnected
import com.fadly.fadence.extensions.showToast
import com.fadly.fadence.playback.equalizer.EqualizerManager
import com.fadly.fadence.playback.library.LibraryProvider
...
import com.fadly.fadence.playback.renderer.AlacWorkaroundCodecSelector
import com.fadly.fadence.playback.renderer.FadenceMusicRenderersFactory
import com.fadly.fadence.ui.screen.MainActivity
import com.fadly.fadence.util.CLEAR_QUEUE_ON_COMPLETION
import com.fadly.fadence.util.ENABLE_HISTORY
import com.fadly.fadence.util.IGNORE_AUDIO_FOCUS
import com.fadly.fadence.util.MP3_INDEX_SEEKING
import com.fadly.fadence.util.PAUSE_ON_ZERO_VOLUME
import com.fadly.fadence.util.PLAY_ON_STARTUP_MODE
import com.fadly.fadence.util.PlayOnStartupMode
import com.fadly.fadence.util.Preferences
import com.fadly.fadence.util.Preferences.requireString
import com.fadly.fadence.util.QUEUE_NEXT_MODE
import com.fadly.fadence.util.REWIND_WITH_BACK
import com.fadly.fadence.util.SEEK_INTERVAL
import com.fadly.fadence.util.STOP_WHEN_CLOSED_FROM_RECENTS
import com.fadly.fadence.util.SongPlayCountHelper
import com.fadly.fadence.util.WIDGET_DYNAMIC_COLORS
import com.fadly.fadence.util.WIDGET_IMAGE_CORNER_RADIUS
import com.fadly.fadence.util.WIDGET_SMALL_LAYOUT_STYLE
...
class PlaybackService :
    ...
    override fun onCreate() {
        ...
        player = AdvancedForwardingPlayer(
            ExoPlayer.Builder(this)
                ...
                .setRenderersFactory(
                    FadenceMusicRenderersFactory(this, balanceProcessor, replayGainProcessor)
    ...
    companion object {
        private const val PACKAGE_NAME = "com.fadly.fadence"
