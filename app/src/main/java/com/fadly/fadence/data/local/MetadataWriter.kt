package com.fadly.fadence.data.local
...
import com.fadly.fadence.extensions.media.createAlbumArtThumbFile
import com.fadly.fadence.extensions.media.deleteAlbumArt
import com.fadly.fadence.extensions.media.insertAlbumArt
...
class MetadataWriter : KoinComponent {
    ...
    private fun createPicture(target: EditTarget): Picture? {
        ...
        return Picture(
            data = byteArray,
            description = "Embedded Front Cover - Fadence Music",
