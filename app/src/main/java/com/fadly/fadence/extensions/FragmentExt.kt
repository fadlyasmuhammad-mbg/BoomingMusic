...
import com.fadly.fadence.extensions.resources.createFadenceMusicBalloon
...
inline fun Fragment.createFadenceMusicBalloon(
    tooltipId: String,
    crossinline block: Balloon.Builder.() -> Unit
) = requestContext { it.createFadenceMusicBalloon(tooltipId, viewLifecycleOwner, block = block) }
