...
import com.fadly.fadence.databinding.FragmentMainRecyclerBinding
import com.fadly.fadence.extensions.createFadenceMusicBalloon
...
import com.fadly.fadence.ui.screen.other.ShuffleModeFragment
    ...
    override fun onStart() {
        ...
        _binding?.shuffleButton?.doOnLayout {
            viewLifecycleOwner.lifecycleScope.launch {
                delay(1000)
                val balloon = createFadenceMusicBalloon("shuffle_button_tip") {
