...
import com.fadly.fadence.databinding.ActivityTagEditorBinding
...
abstract class AbsTagEditorActivity : AbsBaseActivity(),
    ...
    protected open fun selectImage() {
        val items = arrayOf(
            getString(com.fadly.fadence.R.string.download_image),
            getString(com.fadly.fadence.R.string.pick_from_local_storage),
            getString(com.fadly.fadence.R.string.web_search),
            getString(com.fadly.fadence.R.string.restore_default),
            getString(com.fadly.fadence.R.string.remove_cover)
        )
        MaterialAlertDialogBuilder(this)
            .setTitle(com.fadly.fadence.R.string.update_image)
    ...
    private fun writeTags() {
        viewModel.write(this, propertyMap).observe(this) { result ->
            if (result.isLoading) {
                ...
                showToast(com.fadly.fadence.R.string.saving_changes)
            } else {
                binding.actionSave.show()
                if (result.isSuccess) {
                    showToast(com.fadly.fadence.R.string.changes_saved_successfully)
                } else {
                    showToast(com.fadly.fadence.R.string.could_not_save_some_changes)
                }
            }
        }
    }
