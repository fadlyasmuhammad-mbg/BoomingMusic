...
package com.fadly.fadence.ui.screen.tageditor
...
import com.fadly.fadence.coil.DEFAULT_ALBUM_IMAGE
import com.fadly.fadence.data.local.MetadataReader
import com.fadly.fadence.data.local.toBitmap
import com.fadly.fadence.databinding.TagEditorAlbumFieldBinding
import com.fadly.fadence.extensions.resources.getResized
...
class AlbumTagEditorActivity : AbsTagEditorActivity() {
    ...
    override fun downloadOnlineImage() {
        ...
        viewModel.getAlbumInfo(albumArtistNameStr, albumTitleStr).observe(this) { deezerAlbum ->
            if (deezerAlbum != null) {
                val url = deezerAlbum.imageUrl
